...
_Generated: 2026-04-22T08:25:39.802Z_
...
Workspace `mcp.json` _(folder: skills-getting-started-with-github-copilot)_

- **/workspaces/skills-getting-started-with-github-copilot/.vscode/mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **/home/vscode/.config/Code/User/mcp.json** — _File missing_
